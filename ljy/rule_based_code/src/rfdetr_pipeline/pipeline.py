...
class RFDetrPoseMultiViewPipeline:
    ...
    def process(
        ...
        ball_measurements: dict[int, dict] = {}
        ...
        try:
            for frame_number, frames, extractions in progress:
                ...
                if measured_ball_3d is not None:
                    ball_measurements[frame_number] = {
                        "position": measured_ball_3d.astype(float).tolist(),
                        "views": len(selected_balls),
                    }
        ...
        result = {
            ...
            "balls_2d": balls_2d,
            "balls_3d": balls_3d,
            "ball_measurements": ball_measurements,
