...
_MODELS = {
    "ViT-B/32-8": "https://download.openmmlab.com/mmaction/v1.0/projects/actionclip/actionclip_vit-base-p32-res224-clip-pre_1x1x8_k400-rgb/vit-b-32-8f.pth",  # noqa: E501
    "ViT-B/16-8": "https://download.openmmlab.com/mmaction/v1.0/projects/actionclip/actionclip_vit-base-p16-res224-clip-pre_1x1x8_k400-rgb/vit-b-16-8f.pth",  # noqa: E501
    "ViT-B/16-16": "https://download.openmmlab.com/mmaction/v1.0/projects/actionclip/actionclip_vit-base-p16-res224-clip-pre_1x1x16_k400-rgb/vit-b-16-16f.pth",  # noqa: E501
    "ViT-B/16-32": "https://download.openmmlab.com/mmaction/v1.0/projects/actionclip/actionclip_vit-base-p16-res224-clip-pre_1x1x32_k400-rgb/vit-b-16-32f.pth",  # noqa: E501
}
    ...
    if name_or_path in _MODELS:
        ...
        if os.path.exists(name_or_path):
            ...
            if "adapter.frame_position_embeddings.weight" in state_dict:
                num_adapter_segs = state_dict[
                    "adapter.frame_position_embeddings.weight"
                ].shape[0]
            else:
                num_adapter_segs = 8
            ...
            raise ValueError(
                f"Model {name_or_path} not found. Available models: {available_models()}"
            )
