...
def add_custom_config(_C):
    ...
    _C.TRAIN.CROSS_BATCH_META_LEARN = False
    _C.TRAIN.CROSS_BATCH_META_LEARN_RATIO = 0.0
    _C.TRAIN.CROSS_BATCH_META_DEBIAS = False
    _C.TRAIN.CROSS_BATCH_META_DEBIAS_PROB = 0.0
    _C.TRAIN.CROSS_BATCH_META_DEBIAS_BETA = [2, 5]
    _C.TRAIN.CROSS_BATCH_META_MIX = False
    _C.TRAIN.CROSS_BATCH_META_MIX_PROB = 0.0
    _C.TRAIN.CROSS_BATCH_META_MIX_BETA = [2, 5]
    ...
    _C.CROSS_BATCH_META_MIX_ALPHA = 0.0
    # pass
